...
gulp.task('image', function () {//srcに入れた画像を、そのままdistに出力する
...
gulp.task('default', gulp.series('webpack', gulp.parallel('copy', 'pug', 'sass', 'image', 'server', function (done) {
